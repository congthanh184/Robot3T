	...
	; Compiler options:
	;
	; -oDisplayDTHC.cof -mDisplayDTHC.map --summary=default \
	; --output=default main.p1 c16_lcd_driver.p1 dthc_lcd_controller.p1 \
	; usart.p1 --chip=16F887 -P --runtime=default --opt=default -D__DEBUG=1 \
